        ...
        <div className="flex w-full h-[600px] bg-black px-10 gap-10 py-10 border-t border-white">
          ...
          >
            <div className="flex items-center justify-center space-x-3">
              ...
              <div className="text-[60px] font-bold text-pink-500 group-hover:scale-105 transition-transform">
                INSTAGRAM
              </div>
            </div>
            <p className="text-[30px] text-white opacity-80">@mr2_nsw</p>
          </a>
          ...
          >
            <div className="flex items-center justify-center space-x-3">
              ...
              <div className="text-[60px] font-bold text-blue-600 group-hover:scale-105 transition-transform">
                FACEBOOK
              </div>
            </div>
            <p className="text-[30px] text-white opacity-80">
